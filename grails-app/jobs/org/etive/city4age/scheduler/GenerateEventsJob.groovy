...
import org.etive.city4age.repository.ProximityEventList
    ...
    def execute() {
        ...
        for (receiver in careReceivers) {
            ...
            for (; date <= yesterday; date += 1) {
                ProximityEventList list = new ProximityEventList(proximityEventService.forProcessing(receiver, date))
