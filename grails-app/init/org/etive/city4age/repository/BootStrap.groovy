...
class BootStrap {
    ...
    def init = { servletContext ->
        if (Environment.current != Environment.PRODUCTION) {
            ...
            def fourOaksMedicalCentre = new Location(locationId: "FourOaksMedicalCentre", regionId: "MereGreenCentre", name: "Four Oaks Medical Centre", type: "HealthPlace:GP", address: "Carlton House, 18 Mere Green Rd, Sutton Coldfield, B75 5BS", latitude: 52.587231, longitude: -1.827727).save(failOnError: true)
            def sainsburysMereGreen = new Location(locationId: "SainsburysMereGreen", regionId: "MereGreenCentre", name: "Sainsburys, Mere Green", type: "Shop:Supermarket", address: "30 Mere Green Rd, Sutton Coldfield, B75 5BT", latitude: 52.586966, longitude: -1.825429).save(failOnError: true)
            ...
            def lloydsPharmacy = new Location(locationId: "LloydsPharmacy", regionId: "MereGreenCentre", name: "Lloyds Pharmacy", type: "Shop:Pharmacy", address: "Unit 1, 290 Lichfield Rd, Sutton Coldfield, B74 2UG", latitude: 52.586177, longitude: -1.829405).save(failOnError: true)
            def msMereGreenFoodhall = new Location(locationId: "MsMereGreenFoodhall", regionId: "MereGreenCentre", name: "M&S Mere Green Foodhall", type: "Shop:Supermarket", address: "304 Lichfield Rd, Sutton Coldfield, B74 2UG", latitude: 52.586463, longitude: -1.829842).save(failOnError: true)
            def bistrotPierre = new Location(locationId: "BistrotPierre", regionId: "MereGreenCentre", name: "Bistrot Pierre", type: "SocializingPlace:Restaurant", address: "2 Mere Green Rd, Sutton Coldfield, B75 5BP", latitude: 52.587403, longitude: -1.829227).save(failOnError: true)
            def theOldSchoolHouse = new Location(locationId: "TheOldSchoolHouse", regionId: "MereGreenCentre", name: "The Old School House", type: "SocializingPlace:Restaurant", address: "12 Mere Green Rd, Sutton Coldfield, B75 5BL", latitude: 52.587532, longitude: -1.828316).save(failOnError: true)
            def mereGreenCommunityCentre = new Location(locationId: "MereGreenCommunityCentre", regionId: "MereGreenCentre", name: "Mere Green Community Centre", type: "SocializingPlace:SeniorCenter", address: "30A Mere Green Rd, Sutton Coldfield, B75 5BT", latitude: 52.586428, longitude: -1.8274).save(failOnError: true)
            def mereGreenLibrary = new Location(containedBy: mereGreenCommunityCentre, regionId: "MereGreenCentre", locationId: "MereGreenLibrary", name: "Mere Green Library", type: "SocializingPlace:OtherSocialPlace", address: "30A Mere Green Rd, Sutton Coldfield, B75 5BT", latitude: 52.586635, longitude: -1.827299).save(failOnError: true)
            def theMarePoolWetherspoons = new Location(locationId: "TheMarePoolWetherspoons", regionId: "MereGreenCentre", name: "The Mare Pool (Wetherspoons)", type: "SocializingPlace:Restaurant", address: "297 Lichfield Rd, Sutton Coldfield, B74 2UG", latitude: 52.586504, longitude: -1.828528).save(failOnError: true)
            def waitroseTheHighgateCentre = new Location(locationId: "WaitroseTheHighgateCentre", regionId: "MereGreenCentre", name: "Waitrose, The Highgate Centre", type: "Shop:Supermarket", address: "The Highgate Centre, 7 Belwell Lane, Sutton Coldfield, B74 4AB", latitude: 52.587669, longitude: -1.831764).save(failOnError: true)
            ...
            def bootsMereGreen = new Location(locationId: "BootsMereGreen", regionId: "MereGreenCentre", name: "Boots, Mere Green", type: "Shop:Pharmacy", address: "16 Mere Green Rd, Sutton Coldfield, B75 5BP", latitude: 52.587386, longitude: -1.828246).save(failOnError: true)
            ...
            if (Environment.current != Environment.PRODUCTION) {
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:17:45Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:20:57Z").getTime(),
                        rssi: -46,
                        rssiMax: -37,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:21:14Z").getTime(),
                        rssi: -45,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:21:42Z").getTime(),
                        rssi: -45,
                        rssiMax: -41,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:22:01Z").getTime(),
                        rssi: -45,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:22:12Z").getTime(),
                        rssi: -47,
                        rssiMax: -45,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:22:34Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:25:07Z").getTime(),
                        rssi: -41,
                        rssiMax: -37,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:25:24Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:25:46Z").getTime(),
                        rssi: -47,
                        rssiMax: -41,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:26:56Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:28:50Z").getTime(),
                        rssi: -41,
                        rssiMax: -41,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:29:06Z").getTime(),
                        rssi: -47,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:31:12Z").getTime(),
                        rssi: -47,
                        rssiMax: -33,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:32:19Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:35:55Z").getTime(),
                        rssi: -46,
                        rssiMax: -31,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:40:35Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:42:32Z").getTime(),
                        rssi: -47,
                        rssiMax: -35,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:44:38Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:45:22Z").getTime(),
                        rssi: -47,
                        rssiMax: -45,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:48:18Z").getTime(),
                        rssi: -47,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:48:27Z").getTime(),
                        rssi: -47,
                        rssiMax: -45,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:54:19Z").getTime(),
                        rssi: -41,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:54:34Z").getTime(),
                        rssi: -47,
                        rssiMax: -41,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:54:52Z").getTime(),
                        rssi: -47,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:56:00Z").getTime(),
                        rssi: -45,
                        rssiMax: -45,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:56:10Z").getTime(),
                        rssi: -47,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:56:50Z").getTime(),
                        rssi: -46,
                        rssiMax: -41,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:57:18Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:58:32Z").getTime(),
                        rssi: -47,
                        rssiMax: -41,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T13:58:35Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T14:00:43Z").getTime(),
                        rssi: -46,
                        rssiMax: -32,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T14:00:56Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T14:01:51Z").getTime(),
                        rssi: -45,
                        rssiMax: -41,
                        beaconId: "c4a000002740",
                        token: careReceiver3.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T14:06:38Z").getTime(),
                        rssi: -80,
                        txPower: -47,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T14:07:06Z").getTime(),
                        rssi: -92,
                        txPower: -47,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-22T14:08:01Z").getTime(),
                        rssi: -89,
                        rssiMax: -70,
                        beaconId: "c4a000002771",
                        token: careReceiver4.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:10:54Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:12:38Z").getTime(),
                        rssi: -46,
                        rssiMax: -41,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:13:09Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:16:19Z").getTime(),
                        rssi: -31,
                        rssiMax: -31,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:36:31Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:39:10Z").getTime(),
                        rssi: -46,
                        rssiMax: -32,
                        beaconId: "c4a000002712",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:39:39Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:41:46Z").getTime(),
                        rssi: -46,
                        rssiMax: -41,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:42:15Z").getTime(),
                        rssi: -41,
                        txPower: -47,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:42:24Z").getTime(),
                        rssi: -41,
                        rssiMax: -41,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "found",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:42:56Z").getTime(),
                        rssi: -46,
                        txPower: -47,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
                ...
                json = [
                        eventType: "lost",
                        timestamp: new Date().parse("yyyy-MM-dd'T'HH:mm:ssXXX", "2017-10-28T14:43:15Z").getTime(),
                        rssi: -46,
                        rssiMax: -41,
                        beaconId: "c4a000002751",
                        token: careReceiver5.token,
