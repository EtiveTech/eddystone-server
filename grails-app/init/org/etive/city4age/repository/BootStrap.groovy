...
class BootStrap {
    ...
    def init = { servletContext ->
        if (Environment.current == Environment.DEVELOPMENT) {
            ...
            def mereGreenLibrary = new Location(container: mereGreenCommunityCentre, locationId: "MereGreenLibrary", name: "Mere Green Library", type: "SocializingPlace", address: "30A Mere Green Rd, Sutton Coldfield, B75 5BT", latitude: "52.586635", longitude: "-1.827299").save(failOnError: true)
            ...
            def cafeNeroGracechurchShoppingCentre = new Location(container: gracechurchShoppingCentre, locationId: "CafeNeroGracechurchShoppingCentre", name: "Cafe Nero, Gracechurch Shopping Centre", type: "SocializingPlace:Restaurant", address: "56 The Parade, Gracechurch Shopping Centre, Sutton Coldfield, B72 1PD", latitude: "52.562115", longitude: "-1.824471").save(failOnError: true)
            def costaCoffeeGracechurchShoppingCentre = new Location(container: gracechurchShoppingCentre, locationId: "CostaCoffeeGracechurchShoppingCentre", name: "Costa Coffee, Gracechurch Shopping Centre", type: "SocializingPlace:Restaurant", address: "182 The Parade, Gracechurch Shopping Centre,  Sutton Coldfield, B72 1PH", latitude: "52.563056", longitude: "-1.824492").save(failOnError: true)
